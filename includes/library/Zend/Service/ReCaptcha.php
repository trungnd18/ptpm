...
class Zend_Service_ReCaptcha extends Zend_Service_Abstract {
	 ...
	 * @var array
	 */
	protected $_params = array ('ssl' => false, /* Use SSL or not when generating the recaptcha */
	 ...
	 * @param $options array       	
	 * @param $ip string       	
	 * @param $params array|Zend_Config       	
	 */
...
HTML;
	 ...
	 *
	 * @param $challengeField string       	
	 * @param $responseField string       	
	...
	protected function _post($challengeField, $responseField) {
		...
		$postParams = array ('privatekey' => $this->_privateKey, 'remoteip' => $this->_ip, 'challenge' => $challengeField, 'response' => $responseField );
